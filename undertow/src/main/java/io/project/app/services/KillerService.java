...
public class KillerService {
    ...
    private List<String> targetList = Arrays.asList("http://localhost:2020/actuator/shutdown", "http://venera:2077/actuator/shutdown",
            "http://localhost:2021/actuator/shutdown", "http://localhost:2023/actuator/shutdown", "http://mars:8585858585/actuator/shutdown");

    @Scheduled(fixedDelay = 8000)
    public void shoot() {
        log.info("Starting UNDERTOW Operation");
